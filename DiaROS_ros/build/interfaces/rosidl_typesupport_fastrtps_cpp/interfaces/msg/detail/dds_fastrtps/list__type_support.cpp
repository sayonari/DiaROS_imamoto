...
#include "interfaces/msg/detail/list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::List & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::List & ros_message)
{
  // Member: n
  cdr >> ros_message.n;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::List *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::List *>(
    untyped_ros_message);
...
{
  return max_serialized_size_List(full_bounded, 0);
}
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_List__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, List)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_List__handle;
}
